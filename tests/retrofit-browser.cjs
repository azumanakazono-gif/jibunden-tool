...
(async()=>{
 ...
 const d={generation:6000,exportKwh:4000,importKwh:4800,bill:160000,fixedBill:24000,buyRate:30,sellRate:8,capacity:10,reserve:0,efficiency:90,matching:100,nightShare:100,days:365,cost:100,years:15,degradation:0};
 ...
 await page.locator('#rt-result').scrollIntoViewIfNeeded();await page.screenshot({path:'test-results/retrofit-results.png'});
 await page.setViewportSize({width:390,height:844});await page.locator('#rt-result').scrollIntoViewIfNeeded();await page.screenshot({path:'test-results/retrofit-mobile.png',fullPage:true});
